...
import { Agribusiness, Users, Input, Equipment } from "@/components/icons";
...
export default function InputFinancingPage() {
  return (
    <main>
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Reveal className="glass p-[30px]">
              <FeatureIcon icon={Input} className="mb-4" />
      ...
      <CtaBand
        title="Finance your farming season."
        image="https://images.unsplash.com/photo-1523741543316-beb7fc7023d8?w=1700&q=80&auto=format&fit=crop"
        imageAlt="Tractor in field"
