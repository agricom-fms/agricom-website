        ...
        <div className="grid grid-cols-1 gap-[22px] sm:grid-cols-2 lg:grid-cols-4">
          {HOW_IT_WORKS.map((item, index) => (
            <Reveal key={item.step} delay={index * 80} className="text-center">
              <div className="mx-auto mb-[18px] grid h-16 w-16 place-items-center rounded-[20px] bg-gradient-to-br from-green-500 to-green-700 font-display text-[21.5px] font-bold text-white shadow-glow">
                {item.step}
              </div>
